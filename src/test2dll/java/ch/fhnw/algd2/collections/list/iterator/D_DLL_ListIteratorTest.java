...
public class D_DLL_ListIteratorTest extends AbstractListIteratorTest {
	...
	public void testAddingByIndex_AtEnd() {
		...
		checkIteratorForwardsAndBackwards(new Integer[] { one, two, three, four, five, six });
	}
	...
	public void testAddingByIndex_AtStart() {
		...
		addAllNumberToList(allNumbers);
		list.add(0, six);
		checkIteratorForwardsAndBackwards(new Integer[] { six, one, two, three, four, five });
	}
	...
	public void testRemoveByIndex_AtStart() {
		addAllNumberToList(allNumbers);
		list.remove(0);
		checkIteratorForwardsAndBackwards(new Integer[] { two, three, four, five });
	}
	...
	public void testRemoveByElement_InBetween() {
		addAllNumberToList(allNumbers);
		list.remove(two);
		checkIteratorForwardsAndBackwards(new Integer[] { one, three, four, five });
	}
	...
	public void testSetAtHead() {
		...
		it.next();
		it.set(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { zero, two, three, four, five });
	...
	public void testSetAtTail() {
		...
		it.set(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { one, two, three, four, zero });
	}
	...
	public void testSetInBetween() {
		...
		it.next();
		it.set(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { one, zero, three, four, five });
	}
	...
	public void testAddAtHead() {
		...
		it.add(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { zero, one, two, three, four, five });
	...
	public void testAddAtEnd() {
		...
		it.add(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { one, two, three, four, five, zero });
		assertEquals(list.size(), it.nextIndex());
	...
	public void testAddInBetween() {
		...
		it.add(zero);
		checkIteratorForwardsAndBackwards(new Integer[] { one, two, zero, three, four, five });
